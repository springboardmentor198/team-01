...
export default function Report() {
  ...
  return <Layout title="Due Diligence Report"><div className="report-page">
    <header className="report-header"><div><p className="report-eyebrow">Due Diligence Report</p><h1>{property.propertyCode || "Property Report"}</h1><p>Generated {formatDate(new Date())} · <Badge>{property.status || "Draft"}</Badge></p></div><div className="report-actions"><button disabled title="PDF generation will be available soon"><LuDownload />Generate PDF</button><button onClick={() => window.print()}><LuPrinter />Print</button></div></header>
