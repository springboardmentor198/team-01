...
export default function Report() {
  ...
  const load = async () => {
    ...
    try {
      console.log("Loading report for property:", propertyId);
  ...
  const recommendation =
    score <= 30
      ? [
          "Safe to Purchase",
          "Available records indicate a lower due-diligence risk profile.",
        ]
      : score <= 70
        ? [
            "Review Recommended",
            "Review the listed risks and outstanding records before proceeding.",
          ]
        : ["High Risk", "Additional legal verification recommended."];
  return (
    <Layout title="Due Diligence Report">
      <div className="report-page">
        <header className="report-header">
          <div>
            ...
            <p>
              ...
              <Badge>{property.status || "Draft"}</Badge>
            </p>
          </div>
        ...
        <section className="report-card property-report">
          <h2>Property Information</h2>
          <div className="property-summary">
            {property.imageUrl ? (
              <img src={property.imageUrl} alt={property.propertyCode} />
            ) : (
            ...
            <div className="report-fields">
              {[
                ...
                ["Owner", property.ownerName || property.owner?.name],
                ["Status", property.status],
                [
                  "Area",
                  property.lotSizeSqft ? `${property.lotSizeSqft} sq ft` : null,
                ],
          ...
          {risk ? (
            <>
              ...
              <div className="remarks">
                <span>Remarks</span>
                <p>{risk.remarks || "No remarks recorded."}</p>
              </div>
            </>
          ) : (
            <p className="report-muted">
              No risk summary is available for this property.
            </p>
          )}
        </section>
        <section className="report-card">
        ...
        <section
          className={`recommendation ${score > 70 ? "high" : score > 30 ? "medium" : "low"}`}
        >
